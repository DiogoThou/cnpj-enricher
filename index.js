...
app.get('/settings', (req, res) => {
  ...
  <div class="container">
    <h1>✅ Aplicativo Conectado</h1>
    <p>Seu aplicativo foi conectado com sucesso ao HubSpot!</p>
    <p>Você pode adicionar configurações personalizadas aqui futuramente.</p>
  </div>
